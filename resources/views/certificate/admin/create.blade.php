    ...
    <div class="max-w-2xl mx-auto mt-10 bg-white p-6 rounded shadow text-right">
        ...
        @if(session('success'))
            ...
            >
                ...
                <span class="font-semibold">تم حفظ الشهادة بنجاح!</span>
            </div>
        ...
        <h2 class="text-2xl font-bold mb-6">إضافة شهادة جديدة</h2>
        ...
        <form action="{{ route('certificate-create') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input dir="rtl" type="file" id="pdf" name="pdf" accept="application/pdf"
