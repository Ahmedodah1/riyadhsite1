...
@section('content')
    <div class="p-6">
        ...
        {{-- زر إضافة صورة جديدة --}}
        <div class="bg-green-200 w-56 flex justify-center items-center mb-4 rounded-xl hover:scale-105 duration-200 ease-in-out">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow rounded-t-xl">
                ...
                <tr>
                    ...
                    <th class="px-4 py-2 text-right border-b">الإنشاء</th>
                    ...
                    <th class="px-4 py-2 text-right border-b">الدولة</th>
                </tr>
                </thead>
                <tbody>
                @forelse($coins as $coin)
                    <tr class="text-gray-800 text-right">
                        <td class="px-4 py-2 border-b flex space-x-2 justify-end">
                        ...
                        <td class="px-4 py-2 border-b">{{ $coin->country }}</td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="6" class="text-center py-4 text-gray-500">لا توجد عملات مضافة بعد.</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
