    ...
    <div class="flex justify-between items-center container mx-auto relative">
        ...
        <div class=" {{!request()->is('/') ? 'text-black' : 'text-white'}} hidden lg:flex flex-col md:flex-row items-center justify-center gap-8 md:static absolute w-full md:w-auto p-4 md:p-0 z-20 top-full left-0 md:top-auto md:left-auto"
            ...
            <div class="relative group">
                <a href="/whous" class="hover:underline flex items-center space-x-1">
                    <span>من آنا</span>
                </a>
            </div>

            <div class="relative group">
                <a href="{{route('books.index')}}" class="hover:underline flex items-center">
                    <span>{{ __('site.books') }}
</span>
                </a>
            </div>
            ...
            <div class="relative group">
                <a href="{{route('decor')}}" class="hover:underline flex items-center">
            ...
            <div class="relative group">
                <a href="{{route('certificate')}}" class="hover:underline flex items-center">
