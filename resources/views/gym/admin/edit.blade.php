    ...
    <div class="max-w-2xl mx-auto mt-10 bg-white p-6 rounded shadow text-right">
        ...
        <form action="{{ route('gym-update', $gym->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input dir="rtl" value="{{ $gym->title }}" type="text" id="title" name="title"
            ...
            @if($gym->cover_url)
                <div class="mb-2">
                    ...
                    <a href="{{ asset('storage/' . $gym->cover_url) }}" target="_blank" class="text-blue-600 underline">عرض الملف</a>
                </div>
            @endif
            ...
            @if($gym->image)
                <div class="mb-2">
                    ...
                    <img src="{{ asset('public/storage/' . $gym->image) }}" class="h-24 rounded">
                </div>
            @endif
