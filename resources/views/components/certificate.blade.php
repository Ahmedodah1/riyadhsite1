    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mb-10 lg:mb-16 flex justify-center items-center flex-col gap-x-0 gap-y-6 lg:gap-y-0 lg:flex-row lg:justify-between max-md:max-w-lg max-md:mx-auto">
            <div class="relative w-full text-center lg:text-left lg:w-2/4">
                <h2 class=" text-center text-4xl font-bold text-gray-900 leading-[3.25rem] lg:mb-6 mx-auto max-w-max lg:max-w-md lg:mx-0">شهاداتي ... دليلك على التزامي بالاحتراف

                </h2>
            </div>
            <div class="relative w-full text-center  lg:text-left lg:w-2/4">
                <p class=" text-center text-lg font-normal text-gray-500 mb-5">شهادتي تثبت أنني لا أقدّم خدمة فقط، بل أقدّم قيمة مبنية على معرفة.
